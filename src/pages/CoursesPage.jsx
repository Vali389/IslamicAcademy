  ...
  const courses = [
    {
      ...
      description: isUrdu 
        ? 'قرآن مجید کو صحیح تلفظ کے ساتھ پڑھنا سیکھیں۔ یہ کورس بنیادی عربی حروف، ان کی آوازوں، اور قرآنی الفاظ کی صحیح ادائیگی پر مشتمل ہے۔ ہمارے تجربہ کار اساتذہ آپ کو قدم بہ قدم رہنمائی کریں گے تاکہ آپ روانی سے قرآن پڑھ سکیں۔ ہر عمر کے ابتدائی سیکھنے والوں کے لیے بہترین۔ ہفتے میں ۵ دن کلاسز ہوتی ہیں۔'
          ...
          <div className="text-center bg-yellow-50 border border-yellow-200 rounded-xl p-4 max-w-2xl mx-auto">
            <div className="flex items-center justify-center gap-2">
              ...
              <span className="text-yellow-800 font-medium">
                {isUrdu ? 'جمعہ اور ہفتہ چھٹی - تمام کورسز ہفتے میں ۵ دن' : 'Fri & Sat Holiday - All courses run 5 days/week'}
              </span>
            </div>
          </div>
        </AnimatedSection>
